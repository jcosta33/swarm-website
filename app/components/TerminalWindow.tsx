...
export function TerminalWindow({
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-panel border border-panel-border bg-panel-raised shadow-[inset_0_1px_0_rgba(255,255,255,0.1),inset_0_-2px_0_rgba(0,0,0,0.5)] ${className}`}
    >
