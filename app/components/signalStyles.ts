...
export const signalRoleMeta = {
  ...
  evidence: {
    ...
    family: "review / proof",
    hex: "#AAB96A",
    relationship: "olive-sage proof: HSL(71 36% 57%)",
    wheel: "+37° from core",
  ...
  greenfield: {
    ...
    family: "setup path",
    hex: "#5FBE73",
    relationship: "fresh field green: HSL(133 42% 56%)",
    wheel: "+99° from core",
  ...
  brownfield: {
    ...
    family: "setup path",
    hex: "#B47A50",
    relationship: "survey umber: HSL(25 40% 51%)",
    wheel: "-9° from core",
    tone: "survey umber",
  ...
  change: {
    ...
    hex: "#CC735A",
    relationship: "red-clay analogue: HSL(13 53% 58%)",
    wheel: "-21° from core",
    tone: "red clay",
  ...
  reference: {
    ...
    hex: "#70BDB2",
    relationship: "tempered split-complement: HSL(171 37% 59%)",
    wheel: "+137° from core",
