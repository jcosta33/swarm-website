...
const commands = [
  ...
  {
    cmd: "update [--check]",
    what: "Tell you whether your workspace has drifted behind the latest starter kit, and what you would gain by updating. Read-only — it never rewrites your files.",
    icon: ShieldCheck,
  },
  {
    cmd: "check [file]",
