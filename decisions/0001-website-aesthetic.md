...
# DECISION-0001 — Website visual identity
...
- **Tone:** tongue-in-cheek, laid back, open-source — no corporate buzzwords.

## Consequences

- Positive: memorable, ownable aesthetic.
- Negative: yellow on black is high contrast; must ensure accessibility (contrast
  ratios, focus states).
- Neutral: design system spec (SPEC-design-system) codifies the implementation.
